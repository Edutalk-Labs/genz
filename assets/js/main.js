      ...
      <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-duration="1000">
        <div class="pricing-boxarea ${index % 2 != 0 ? "active" : ""}">
          ...
          <div class="list-area">
            ...
            <ul>
              <li> <img src="assets/img/icons/check2.svg" alt="" class="check2" /><img src="assets/img/icons/check3.svg" alt="" class="check3" />Giá trị còn lại: ${gift.value_remaining?.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }) || "N/A"}</li>
